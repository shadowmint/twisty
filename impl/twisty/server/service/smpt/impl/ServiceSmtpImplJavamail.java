 ...
 */
public class ServiceSmtpImplJavamail extends ServiceImpl implements ServiceSmtp {
	...
	public String getServiceImpl() {
		return("JavaMail (http://java.sun.com/products/javamail/) based implementation.");
	}
