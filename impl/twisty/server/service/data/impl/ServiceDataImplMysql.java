 ...
 * <li> http://openjpa.apache.org/
 * <li> http://dev.mysql.com/downloads/connector/j/
 */
public class ServiceDataImplMysql extends ServiceImpl implements ServiceData {
	...
	public String getServiceImpl() {
		return("OpenJDA (http://openjpa.apache.org/) and Mysql (http://dev.mysql.com/downloads/connector/j/) based implementation.");
	}
	...
	public void connect(Map<String, String> properties) throws Exception {
		if (entityManager == null) {
			...
			props.put("openjpa.ConnectionURL", "jdbc:mysql://" + properties.get(ServiceData.URL));
			props.put("openjpa.ConnectionDriverName", "com.mysql.jdbc.Driver");
			props.put("openjpa.ConnectionUserName", properties.get(ServiceData.USERNAME));
			props.put("openjpa.ConnectionPassword", properties.get(ServiceData.PASSWORD));
	        props.put("openjpa.RuntimeUnenhancedClasses", "supported"); 
	        props.put("openjpa.MetaDataFactory", "jpa(Types=" + properties.get(ServiceData.CLASSES) + ")"); 
	...
	public HashMap<String, String> getConnectionTemplate() {
		...
		rtn.put(ServiceData.PROFILE, "mysql");
